...
remove(temp_eemeans2,temporal_CL_lm,Sr_temporal_lm,temp_sum)# cleans up work environment to point


#################Generalized Linear Model, distribution = Gamma, Link = Inverse --Knowns (water otolith relationship) includes f-test for overall model##############
